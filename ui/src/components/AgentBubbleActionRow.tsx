  ...
  return (
    <div className={cn("mt-2 flex items-center gap-1", className)}>
      <button
        ...
        title={t("agentBubbleActionRow.actions.copyMessage", { defaultValue: "Copy message" })}
        aria-label={t("agentBubbleActionRow.actions.copyMessage", { defaultValue: "Copy message" })}
        onClick={() => {
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            title={t("agentBubbleActionRow.actions.moreActions", { defaultValue: "More actions" })}
            aria-label={t("agentBubbleActionRow.actions.moreActions", { defaultValue: "More actions" })}
          >
        ...
        <DropdownMenuContent align="end">
          ...
          >
            ...
            {t("agentBubbleActionRow.actions.copyMessage", { defaultValue: "Copy message" })}
          </DropdownMenuItem>
          {menuItems}
        </DropdownMenuContent>
      </DropdownMenu>
  ...
  return (
    <>
      <button
        ...
        title={t("agentBubbleActionRow.feedback.helpful", { defaultValue: "Helpful" })}
        aria-label={t("agentBubbleActionRow.feedback.helpful", { defaultValue: "Helpful" })}
      ...
      <Popover open={reasonOpen} onOpenChange={setReasonOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            title={t("agentBubbleActionRow.feedback.needsWork", { defaultValue: "Needs work" })}
            aria-label={t("agentBubbleActionRow.feedback.needsWork", { defaultValue: "Needs work" })}
        ...
        <PopoverContent side="top" align="start" className="w-80 p-3">
          <div className="mb-2 text-sm font-medium">{t("agentBubbleActionRow.feedback.reasonPrompt", { defaultValue: "What could have been better?" })}</div>
          <Textarea
            value={downvoteReason}
            onChange={(event) => setDownvoteReason(event.target.value)}
            placeholder={t("agentBubbleActionRow.feedback.reasonPlaceholder", { defaultValue: "Add a short note" })}
          ...
          <div className="mt-2 flex items-center justify-end gap-2">
            ...
            >
              {t("agentBubbleActionRow.actions.dismiss", { defaultValue: "Dismiss" })}
            </Button>
            <Button
              type="button"
              size="sm"
            ...
            >
              {isSaving
                ? t("agentBubbleActionRow.actions.saving", { defaultValue: "Saving..." })
                : t("agentBubbleActionRow.actions.saveNote", { defaultValue: "Save note" })}
            </Button>
          </div>
        </PopoverContent>
      </Popover>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("agentBubbleActionRow.sharing.title", { defaultValue: "Save your feedback sharing preference" })}</DialogTitle>
            <DialogDescription>
              {t("agentBubbleActionRow.sharing.description", {
                defaultValue:
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>{t("agentBubbleActionRow.sharing.savedLocally", { defaultValue: "This vote is always saved locally." })}</p>
            <p>
              {t("agentBubbleActionRow.sharing.shareLead", { defaultValue: "Choose " })}
              <span className="font-medium text-foreground">{t("agentBubbleActionRow.sharing.alwaysAllow", { defaultValue: "Always allow" })}</span>
              {t("agentBubbleActionRow.sharing.betweenClause", {
                defaultValue: " to share this vote and future voted AI outputs. Choose ",
              })}
              <span className="font-medium text-foreground">{t("agentBubbleActionRow.sharing.dontAllow", { defaultValue: "Don't allow" })}</span>
              {t("agentBubbleActionRow.sharing.keepLocalClause", {
                defaultValue: " to keep this vote and future votes local.",
              })}
            </p>
            <p>{t("agentBubbleActionRow.sharing.changeLater", { defaultValue: "You can change this later in Instance Settings > General." })}</p>
            {termsUrl ? (
              <a
                href={termsUrl}
                target="_blank"
              ...
              >
                {t("agentBubbleActionRow.sharing.readTerms", { defaultValue: "Read our terms of service" })}
              </a>
            ) : null}
          </div>
          <DialogFooter>
            ...
            >
              {isSaving
                ? t("agentBubbleActionRow.actions.saving", { defaultValue: "Saving..." })
                : t("agentBubbleActionRow.sharing.dontAllow", { defaultValue: "Don't allow" })}
            </Button>
            <Button
              type="button"
              disabled={!pendingSharingDialog || isSaving}
            ...
            >
              {isSaving
                ? t("agentBubbleActionRow.actions.saving", { defaultValue: "Saving..." })
                : t("agentBubbleActionRow.sharing.alwaysAllow", { defaultValue: "Always allow" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
