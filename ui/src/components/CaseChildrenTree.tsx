  ...
  if (children.length === 0) {
    return (
      <p className="text-xs text-muted-foreground">
        {t("caseChildrenTree.empty", { defaultValue: "No child cases." })}
      </p>
    );
  }
    ...
    <div className="space-y-1">
          ...
          <li key={child.id}>
            ...
            >
              <CaseCopyableToken
                ...
                label={t("caseChildrenTree.caseIdLabel", { defaultValue: "case ID" })}
      ...
      {hiddenCount > 0 ? (
        ...
        >
          ...
          {t("caseChildrenTree.showMore", { defaultValue: "Show {{hiddenCount}} more", hiddenCount })}
        </Button>
      ) : null}
    </div>
  );
