...
function detailText(window: QuotaWindow): string | null {
  ...
  return t("codexSubscriptionPanel.window.resets", { defaultValue: "Resets {{date}}", date: formatted });
}
      ...
      <div className="flex items-start justify-between gap-3 border-b border-border pb-3">
        <div className="min-w-0">
          ...
          <div className="mt-1 text-sm text-muted-foreground">
            {t("codexSubscriptionPanel.subtitle", { defaultValue: "Live Codex quota windows." })}
          </div>
        </div>
        {source ? (
    ...
    <div className="border border-border px-3.5 py-3">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="shrink-0 text-sm font-semibold tabular-nums text-foreground">
          {t("codexSubscriptionPanel.window.usedPercent", { defaultValue: "{{percent}}% used", percent: window.usedPercent })}
        </div>
      </div>
