          ...
          <div className="flex items-center justify-between px-5 py-3 text-white/80 text-sm shrink-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                title={t("imageGalleryModal.actions.download", { defaultValue: "Download" })}
                aria-label={t("imageGalleryModal.actions.downloadFile", { defaultValue: "Download {{filename}}", filename })}
              ...
              <button
                ...
                className="text-white/50 hover:text-white transition-colors"
                title={t("imageGalleryModal.actions.close", { defaultValue: "Close" })}
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="w-16 md:w-24 shrink-0 flex items-center justify-center h-full">
              {items.length > 1 && (
                <button
                  ...
                  title={t("imageGalleryModal.actions.previous", { defaultValue: "Previous" })}
                >
            ...
            <div className="w-16 md:w-24 shrink-0 flex items-center justify-center h-full">
              {items.length > 1 && (
                <button
                  ...
                  onClick={goNext}
                  className="rounded-full bg-white/10 p-3 text-white/60 hover:text-white hover:bg-white/20 transition-colors"
                  title={t("imageGalleryModal.actions.next", { defaultValue: "Next" })}
                >
