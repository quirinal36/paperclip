...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("mobileBottomNav.nav.home", { defaultValue: "Home" }), icon: House },
      { type: "link", to: "/issues", label: t("mobileBottomNav.nav.tasks", { defaultValue: "Tasks" }), icon: CircleDot },
      { type: "action", label: t("mobileBottomNav.nav.create", { defaultValue: "Create" }), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("mobileBottomNav.nav.agents", { defaultValue: "Agents" }), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("mobileBottomNav.nav.inbox", { defaultValue: "Inbox" }),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("mobileBottomNav.ariaLabel", { defaultValue: "Mobile navigation" })}
    >
