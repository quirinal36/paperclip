    ...
    <>
      ...
      >
        {saveConflict ? (
          <div className="flex items-center gap-2 text-sm text-amber-800 dark:text-amber-200">
            ...
            <span>
              {t("routineSaveBar.conflict.message", {
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                <span className="font-medium">
                  {dirtyCount === 1
                    ? t("routineSaveBar.unsavedCountSingular", {
                        defaultValue: "{{changeCount}} unsaved change",
                        changeCount: dirtyCount,
                      })
                    : t("routineSaveBar.unsavedCountPlural", {
                        defaultValue: "{{changeCount}} unsaved changes",
                        changeCount: dirtyCount,
                      })}
                </span>
              </button>
            ...
            <PopoverContent align="start" className="w-64">
              <p className="mb-2 text-xs font-medium text-muted-foreground">
                {t("routineSaveBar.pendingChanges", {
          ...
          {saveConflict ? (
            <>
              <Button variant="outline" size="sm" onClick={onReload}>
                {t("routineSaveBar.actions.reloadLatest", {
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      {t("routineSaveBar.actions.overwriteAnyway", {
                        defaultValue: "Overwrite anyway",
                      })}
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    {t("routineSaveBar.overwriteTooltip", {
                      defaultValue:
            ...
            <>
              ...
              >
                {t("routineSaveBar.actions.discard", {
              ...
              >
                {isSaving ? <Loader2 className="mr-1.5 h-3.5 w-3.5 animate-spin" /> : null}
                {t("routineSaveBar.actions.saveChanges", {
      ...
      <Dialog open={confirmDiscardOpen} onOpenChange={setConfirmDiscardOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t("routineSaveBar.discardDialog.title", {
                defaultValue: "Discard changes?",
              })}
            </DialogTitle>
            <DialogDescription>
              {dirtyCount === 1
                ? t("routineSaveBar.discardDialog.descriptionSingular", {
                    defaultValue:
                      "This will revert {{changeCount}} unsaved change in this section.",
                    changeCount: dirtyCount,
                  })
                : t("routineSaveBar.discardDialog.descriptionPlural", {
                    defaultValue:
                      "This will revert {{changeCount}} unsaved changes in this section.",
                    changeCount: dirtyCount,
                  })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="ghost" size="sm" onClick={() => setConfirmDiscardOpen(false)}>
              {t("routineSaveBar.actions.keepEditing", {
            ...
            >
              {t("routineSaveBar.actions.discardChanges", {
                defaultValue: "Discard changes",
              })}
            </Button>
          </DialogFooter>
