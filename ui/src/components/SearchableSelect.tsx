...
>({
  ...
  const resolvedSearchPlaceholder =
    searchPlaceholder ?? t("searchableSelect.searchPlaceholder", { defaultValue: "Search..." });
  const resolvedEmptyMessage =
    emptyMessage ?? t("searchableSelect.emptyMessage", { defaultValue: "No options found." });
  const resolvedLoadingMessage =
    loadingMessage ?? t("searchableSelect.loadingMessage", { defaultValue: "Loading..." });
