...
function ProjectItem({
  ...
  const link = (
    ...
    >
      ...
      {!rail && project.pauseReason === "budget" ? <BudgetSidebarMarker title={t("sidebarProjects.project.pausedByBudget", { defaultValue: "Project paused by budget" })} /> : null}
    </NavLink>
  );
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              aria-label={t("sidebarProjects.project.openActions", { defaultValue: "Open actions for {{name}}", name: project.name })}
            >
          ...
          <DropdownMenuContent align="end" className="w-44">
            ...
            >
              ...
              <span>{leaving ? t("sidebarProjects.project.leaving", { defaultValue: "Leaving..." }) : t("sidebarProjects.project.leave", { defaultValue: "Leave project" })}</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        )}
...
export function SidebarProjects() {
  ...
  const sortChoices = useMemo<SidebarSectionRadioChoice[]>(
    () => [
      { value: "top", label: t("sidebarProjects.sort.top", { defaultValue: "Top" }) },
      { value: "alphabetical", label: t("sidebarProjects.sort.alphabetical", { defaultValue: "Alphabetical" }) },
      { value: "recent", label: t("sidebarProjects.sort.recent", { defaultValue: "Recent" }) },
    ],
    [t],
  );
  ...
  return (
    <SidebarSection
      label={t("sidebarProjects.title", { defaultValue: "Projects" })}
      collapsible={{ open, onOpenChange: setOpen }}
      headerAction={{
        ariaLabel: t("sidebarProjects.actions.newProject", { defaultValue: "New project" }),
        icon: Plus,
        onClick: openNewProject,
      }}
      menu={{
        ariaLabel: t("sidebarProjects.menu.sectionActions", { defaultValue: "Projects section actions" }),
        actions: [
          { type: "item", label: t("sidebarProjects.menu.browseProjects", { defaultValue: "Browse projects" }), icon: FolderOpen, href: "/projects" },
          { type: "separator" },
        ],
        radioLabel: t("sidebarProjects.sort.label", { defaultValue: "Project sort" }),
