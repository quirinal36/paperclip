...
export function SidebarStarredProjects() {
  ...
  return (
    <div
      ...
      aria-label={t("sidebarStarredProjects.ariaLabel", { defaultValue: "Starred projects" })}
    >
        ...
        const link = (
          ...
          >
            ...
            {!rail && project.pauseReason === "budget" ? (
              <BudgetSidebarMarker
                title={t("sidebarStarredProjects.budgetPaused.title", {
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    aria-label={t("sidebarStarredProjects.actions.openActions", {
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  >
                    ...
                    <span>
                      {t("sidebarStarredProjects.actions.removeFromStarred", {
                  ...
                  >
                    ...
                    <span>
                      {t("sidebarStarredProjects.actions.leaveProject", {
                        defaultValue: "Leave project",
                      })}
                    </span>
                  </DropdownMenuItem>
                </DropdownMenuContent>
