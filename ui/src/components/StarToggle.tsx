...
export function StarToggle({
  ...
  const ariaLabel = starred
    ? t("starToggle.actions.unstar", { defaultValue: "Unstar {{resourceName}}", resourceName })
    : t("starToggle.actions.star", { defaultValue: "Star {{resourceName}}", resourceName });
  ...
  if (size === "button") {
    return (
      <Button
        ...
        disabled={pending}
        onClick={handleClick}
        title={error ? t("starToggle.errors.retryTitle", { defaultValue: "Couldn't save — retry" }) : undefined}
        className={cn(
          error
