...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("orgChart.empty.noCompany", { defaultValue: "Select a company to view the org chart." })} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("orgChart.empty.noHierarchy", { defaultValue: "No organizational hierarchy defined." })} />;
  }
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {t("orgChart.actions.importCompany", { defaultValue: "Import company" })}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {t("orgChart.actions.exportCompany", { defaultValue: "Export company" })}
          </Button>
        </Link>
      </div>
      <div
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          <button
            ...
            title={t("orgChart.zoom.zoomIn", { defaultValue: "Zoom in" })}
            aria-label={t("orgChart.zoom.zoomIn", { defaultValue: "Zoom in" })}
          >
          ...
          <button
            ...
            title={t("orgChart.zoom.zoomOut", { defaultValue: "Zoom out" })}
            aria-label={t("orgChart.zoom.zoomOut", { defaultValue: "Zoom out" })}
          >
          ...
          <button
            ...
            onClick={fitToScreen}
            title={t("orgChart.zoom.fitToScreen", { defaultValue: "Fit to screen" })}
            aria-label={t("orgChart.zoom.fitToScreenLabel", { defaultValue: "Fit chart to screen" })}
          >
