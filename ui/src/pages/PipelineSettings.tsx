...
const STAGE_NAV_GROUPS: Array<{
  ...
  {
    label: t("pipelineSettings.nav.groups.stage", { defaultValue: "Stage" }),
    items: [
      { id: "instructions", label: t("pipelineSettings.nav.items.instructions", { defaultValue: "Automation" }), icon: LayoutGrid },
      { id: "advanced", label: t("pipelineSettings.nav.items.advanced", { defaultValue: "Advanced" }), icon: SlidersHorizontal },
      { id: "secrets", label: t("pipelineSettings.nav.items.secrets", { defaultValue: "Secrets" }), icon: KeyRound },
    ],
  },
  {
    label: t("pipelineSettings.nav.groups.operate", { defaultValue: "Operate" }),
    items: [
      { id: "activity", label: t("pipelineSettings.nav.items.activity", { defaultValue: "Activity" }), icon: ActivityIcon },
      { id: "history", label: t("pipelineSettings.nav.items.history", { defaultValue: "History" }), icon: HistoryIcon },
    ],
  },
];

const STAGE_SECTION_TITLES: Record<StageSectionKey, string> = {
  instructions: t("pipelineSettings.sections.instructions", { defaultValue: "Automation" }),
  secrets: t("pipelineSettings.sections.secrets", { defaultValue: "Secrets" }),
  activity: t("pipelineSettings.sections.activity", { defaultValue: "Activity" }),
  history: t("pipelineSettings.sections.history", { defaultValue: "History" }),
  advanced: t("pipelineSettings.sections.advanced", { defaultValue: "Advanced" }),
};
...
const STAGE_KIND_OPTIONS: Array<{
  ...
  {
    value: "working",
    label: t("pipelineSettings.stageKind.working.label", { defaultValue: "Working" }),
    description: t("pipelineSettings.stageKind.working.description", {
      defaultValue: "Items wait here while work happens. An agent or a person moves them forward.",
    }),
    icon: Hammer,
  },
  {
    value: "review",
    label: t("pipelineSettings.stageKind.review.label", { defaultValue: "Review" }),
    description: t("pipelineSettings.stageKind.review.description", {
      defaultValue: "Someone has to approve before items leave. Use this when a person or an agent has to say yes or no.",
    }),
    icon: BadgeCheck,
  },
  {
    value: "done",
    label: t("pipelineSettings.stageKind.done.label", { defaultValue: "Done" }),
    description: t("pipelineSettings.stageKind.done.description", {
      defaultValue: "The final step. Items that reach here are finished.",
    }),
    icon: CircleCheck,
  },
  {
    value: "cancelled",
    label: t("pipelineSettings.stageKind.cancelled.label", { defaultValue: "Cancelled" }),
    description: t("pipelineSettings.stageKind.cancelled.description", {
      defaultValue: "The dead end. Items that reach here are dropped or rejected.",
    }),
    icon: Ban,
  },
];
...
const STAGE_EXECUTION_WORKSPACE_OPTIONS = [
  { value: "shared_workspace", label: t("pipelineSettings.executionWorkspace.mode.shared_workspace", { defaultValue: "Project default" }) },
  { value: "isolated_workspace", label: t("pipelineSettings.executionWorkspace.mode.isolated_workspace", { defaultValue: "New isolated workspace" }) },
  { value: "reuse_existing", label: t("pipelineSettings.executionWorkspace.mode.reuse_existing", { defaultValue: "Reuse existing workspace" }) },
] as const;
...
function fieldOriginLabel(depth: number, pipelineName: string) {
  if (depth === 0) return t("pipelineSettings.carryOver.origin.thisItem", { defaultValue: "This item" });
  if (depth === 1) return t("pipelineSettings.carryOver.origin.parent", { defaultValue: "Parent: {{pipelineName}}", pipelineName });
  if (depth === 2) return t("pipelineSettings.carryOver.origin.grandparent", { defaultValue: "Grandparent: {{pipelineName}}", pipelineName });
  return t("pipelineSettings.carryOver.origin.ancestor", { defaultValue: "Ancestor {{depth}}: {{pipelineName}}", depth, pipelineName });
}
...
function automationVariablePreviewTitle(variable: AutomationVariableOption) {
  ...
  const count = typeof variable.example === "string" ? variable.example.length : preview.length;
  const size = t("pipelineSettings.automationVariables.preview.chars", { defaultValue: "{{count}} chars", count });
  const lines = [
    variable.description,
    t("pipelineSettings.automationVariables.preview.example", {
      defaultValue: "Example: {{kind}}, {{size}}",
      kind: automationVariableKind(variable.example),
      size,
    }),
  ];
  if (variable.exampleSource) {
    lines.push(t("pipelineSettings.automationVariables.preview.from", { defaultValue: "From {{source}}", source: variable.exampleSource }));
  }
...
function buildAutomationVariableGroups(input: {
  ...
  const pipelineVariables: AutomationVariableOption[] = [
    {
      key: "pipeline_id",
      label: t("pipelineSettings.automationVariables.vars.pipelineId.label", { defaultValue: "Pipeline ID" }),
      description: t("pipelineSettings.automationVariables.vars.pipelineId.description", {
        defaultValue: "ID of the pipeline this automation runs in.",
      }),
    ...
    {
      key: "pipeline_key",
      label: t("pipelineSettings.automationVariables.vars.pipelineKey.label", { defaultValue: "Pipeline key" }),
      description: t("pipelineSettings.automationVariables.vars.pipelineKey.description", {
        defaultValue: "Stable key of the pipeline this automation runs in.",
      }),
    ...
    {
      key: "pipeline_name",
      label: t("pipelineSettings.automationVariables.vars.pipelineName.label", { defaultValue: "Pipeline name" }),
      description: t("pipelineSettings.automationVariables.vars.pipelineName.description", {
        defaultValue: "Display name of the pipeline this automation runs in.",
      }),
    ...
    {
      key: "stage_id",
      label: t("pipelineSettings.automationVariables.vars.stageId.label", { defaultValue: "Stage ID" }),
      description: t("pipelineSettings.automationVariables.vars.stageId.description", {
        defaultValue: "ID of this automation stage.",
      }),
    ...
    {
      key: "stage_key",
      label: t("pipelineSettings.automationVariables.vars.stageKey.label", { defaultValue: "Stage key" }),
      description: t("pipelineSettings.automationVariables.vars.stageKey.description", {
        defaultValue: "Stable key of this automation stage.",
      }),
    ...
    {
      key: "stage_name",
      label: t("pipelineSettings.automationVariables.vars.stageName.label", { defaultValue: "Stage name" }),
      description: t("pipelineSettings.automationVariables.vars.stageName.description", {
        defaultValue: "Display name of this automation stage.",
      }),
  ...
  const itemVariables: AutomationVariableOption[] = [
    {
      key: "title",
      label: t("pipelineSettings.automationVariables.vars.title.label", { defaultValue: "Item title" }),
      description: t("pipelineSettings.automationVariables.vars.title.description", {
        defaultValue: "Title of the item being automated.",
      }),
    ...
    {
      key: "body",
      label: t("pipelineSettings.automationVariables.vars.body.label", { defaultValue: "Item body" }),
      description: t("pipelineSettings.automationVariables.vars.body.description", {
        defaultValue: "Body text of the item being automated.",
      }),
    ...
    {
      key: "case_id",
      label: t("pipelineSettings.automationVariables.vars.caseId.label", { defaultValue: "Item ID" }),
      description: t("pipelineSettings.automationVariables.vars.caseId.description", {
        defaultValue: "ID of the item being automated.",
      }),
    ...
    {
      key: "case_key",
      label: t("pipelineSettings.automationVariables.vars.caseKey.label", { defaultValue: "Item key" }),
      description: t("pipelineSettings.automationVariables.vars.caseKey.description", {
        defaultValue: "Stable key of the item being automated.",
      }),
    ...
    {
      key: "case_title",
      label: t("pipelineSettings.automationVariables.vars.caseTitle.label", { defaultValue: "Item title alias" }),
      description: t("pipelineSettings.automationVariables.vars.caseTitle.description", {
        defaultValue: "Compatibility alias for the item title.",
      }),
      example: sampleCase?.title ?? "",
      exampleSource,
    },
    {
      key: "case_version",
      label: t("pipelineSettings.automationVariables.vars.caseVersion.label", { defaultValue: "Item version" }),
      description: t("pipelineSettings.automationVariables.vars.caseVersion.description", {
        defaultValue: "Current item version when the automation runs.",
      }),
  ...
  for (const [key, value] of Object.entries(fields)) {
    ...
    fieldVariables.push({
      ...
      description: t("pipelineSettings.automationVariables.fieldCopiedDescription", {
        defaultValue: "Field copied from the current item data.",
      }),
      example: value,
      exampleSource,
    });
  ...
  const groups: AutomationVariableGroup[] = [
    { id: "pipeline", label: t("pipelineSettings.automationVariables.groups.pipeline", { defaultValue: "Pipeline and stage" }), variables: pipelineVariables },
    { id: "item", label: t("pipelineSettings.automationVariables.groups.item", { defaultValue: "Current item" }), variables: itemVariables },
  ];
  if (fieldVariables.length > 0) {
    groups.push({ id: "fields", label: t("pipelineSettings.automationVariables.groups.fields", { defaultValue: "Item fields" }), variables: fieldVariables });
  }
  return groups;
}
    ...
    <div className="rounded-md border border-dashed border-border bg-muted/25 px-3 py-2">
      <div className="mb-2 flex flex-wrap items-center gap-2">
        <span className="text-xs font-semibold uppercase text-muted-foreground">
          {t("pipelineSettings.carriedFields.heading", { defaultValue: "Already available on child items" })}
        </span>
      </div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {group.fields.map((field) => (
                <button
                  ...
                  title={t("pipelineSettings.tokens.insertAria", { defaultValue: "Insert {{token}}", token: `{{${field.key}}}` })}
                  aria-label={t("pipelineSettings.tokens.insertAria", { defaultValue: "Insert {{token}}", token: `{{${field.key}}}` })}
                >
                  {`{{${field.key}}}`}
                </button>
              ))}
...
function AutomationVariableTokenHelper({
  ...
  return (
    <div className="rounded-md border border-border bg-muted/20 px-3 py-2">
      <div className="mb-2 flex flex-wrap items-center gap-2">
        <span className="text-xs font-semibold uppercase text-muted-foreground">
          {label ?? t("pipelineSettings.automationVariables.availableHeading", { defaultValue: "Available variables" })}
        </span>
      </div>
      <div className="space-y-2">
        {groups.map((group) => (
            ...
            <div className="flex flex-wrap gap-1.5">
              {group.variables.map((variable) => (
                <button
                  ...
                  aria-label={t("pipelineSettings.tokens.insertAria", { defaultValue: "Insert {{token}}", token: `{{${variable.key}}}` })}
                >
                  {`{{${variable.key}}}`}
                </button>
              ))}
  ...
  return (
    <>
      <div className="md:hidden">
        <label className="sr-only" htmlFor="stage-section-picker">{t("pipelineSettings.nav.sectionPickerLabel", { defaultValue: "Stage section" })}</label>
        <select
      ...
      <nav
        aria-label={t("pipelineSettings.nav.sectionsAria", { defaultValue: "Stage sections" })}
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              ...
              {event.actorAgent ? t("pipelineSettings.activity.byActor", { defaultValue: " by {{name}}", name: event.actorAgent.name }) : null}
            </p>
          </div>
        </div>
      ))}
...
export function PipelineSettings() {
  ...
  const createSecret = useMutation({
    mutationFn: (input: { name: string; value: string }) => {
      if (!selectedCompanyId) throw new Error(t("pipelineSettings.errors.selectCompanyToCreateSecrets", { defaultValue: "Select a company to create secrets" }));
  ...
  useEffect(() => {
    if (!pipeline) return;
    setBreadcrumbs([
      { label: t("pipelineSettings.breadcrumbs.pipelines", { defaultValue: "Pipelines" }), href: "/pipelines" },
      { label: pipeline.name, href: `/pipelines/${pipeline.id}` },
      { label: t("pipelineSettings.breadcrumbs.settings", { defaultValue: "Settings" }) },
    ]);
  ...
  const saveStage = useMutation({
    mutationFn: async () => {
      ...
      if (
        ...
        throw new Error(t("pipelineSettings.errors.chooseExistingWorkspace", { defaultValue: "Choose an existing workspace before saving this stage." }));
      }
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("pipelineSettings.toast.stageSaved", { defaultValue: "Stage saved" }), tone: "success" });
    },
    onError: async (error) => {
      pushToast({
        title: t("pipelineSettings.toast.saveStageFailed", { defaultValue: "Failed to save stage" }),
        body: error instanceof Error ? error.message : t("pipelineSettings.toast.saveStageFailedBody", { defaultValue: "Paperclip could not save the stage." }),
        tone: "error",
      });
    },
  });
  ...
  const saveStageEnv = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("pipelineSettings.toast.stageSecretsSaved", { defaultValue: "Stage secrets saved" }), tone: "success" });
    },
    onError: async (error) => {
      pushToast({
        title: t("pipelineSettings.toast.saveSecretsFailed", { defaultValue: "Failed to save secrets" }),
        body: error instanceof ApiError
          ? error.message
          : error instanceof Error
            ? error.message
            : t("pipelineSettings.toast.saveSecretsFailedBody", { defaultValue: "Paperclip could not save the stage secrets." }),
        tone: "error",
      });
    },
  });
  ...
  const addStage = useMutation({
    mutationFn: async (afterStage: PipelineStage | null) => {
      ...
      const created = await pipelinesApi.createStage(pipelineId, {
        ...
        name: t("pipelineSettings.stageDefaults.newStageName", { defaultValue: "New stage" }),
        kind: "working",
    ...
    onSuccess: async (created) => {
      ...
      pushToast({ title: t("pipelineSettings.toast.stageAdded", { defaultValue: "Stage added" }), tone: "success" });
    },
  });
  ...
  const deleteStage = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("pipelineSettings.toast.stageDeleted", { defaultValue: "Stage deleted" }), tone: "success" });
    },
    onError: (error) => {
      pushToast({
        title: t("pipelineSettings.toast.deleteStageFailed", { defaultValue: "Failed to delete stage" }),
        body: error instanceof Error ? error.message : t("pipelineSettings.toast.deleteStageFailedBody", { defaultValue: "Paperclip could not delete the stage." }),
        tone: "error",
      });
    },
  });
  ...
  const savePipelineDetails = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("pipelineSettings.toast.pipelineUpdated", { defaultValue: "Pipeline updated" }), tone: "success" });
    },
  });
  ...
  const saveStrictTransitions = useMutation({
    ...
    onSuccess: async () => {
      await refreshPipeline();
      pushToast({ title: t("pipelineSettings.toast.transitionRulesUpdated", { defaultValue: "Transition rules updated" }), tone: "success" });
    },
    onError: (error) => {
      setStrictTransitionsEnabled(pipeline?.enforceTransitions ?? false);
      pushToast({
        title: t("pipelineSettings.toast.updateTransitionRulesFailed", { defaultValue: "Failed to update transition rules" }),
        body: error instanceof Error ? error.message : t("pipelineSettings.toast.updateTransitionRulesFailedBody", { defaultValue: "Paperclip could not update transition rules." }),
        tone: "error",
      });
    },
  });
  ...
  const archivePipeline = useMutation({
    ...
    onSuccess: async (_result, archived) => {
      ...
      if (archived) {
        ...
        await refreshPipeline();
        pushToast({ title: t("pipelineSettings.toast.pipelineRestored", { defaultValue: "Pipeline restored" }), tone: "success" });
      }
    },
  });
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Hexagon} message={t("pipelineSettings.empty.selectCompany", { defaultValue: "Select a company to edit pipeline settings." })} />;
  }

  if (!pipelineId) {
    return <EmptyState icon={Hexagon} message={t("pipelineSettings.empty.noPipelineSelected", { defaultValue: "No pipeline selected." })} />;
  }
  ...
  if (!pipeline) {
    return <EmptyState icon={Hexagon} message={t("pipelineSettings.empty.pipelineNotFound", { defaultValue: "Pipeline not found." })} />;
  }
  ...
  const transitionTargetsControl = !isReviewStage && !isPipelineTerminalStageKind(stageKind) ? (
    <FieldRow label={t("pipelineSettings.fields.allowedNextSteps", { defaultValue: "Allowed next steps" })}>
      <div className="space-y-2">
        {otherStages.map((stage) => {
          ...
          return (
            ...
            >
              ...
              {isCancelled ? (
                <span className="text-xs text-muted-foreground">{t("pipelineSettings.transitions.alwaysAvailable", { defaultValue: "Always available" })}</span>
              ) : null}
            </label>
          );
        })}
    ...
    <div className="rounded-lg border border-border">
      <div className="flex items-start justify-between gap-4 border-b border-border p-4">
        <div className="space-y-1">
          <h3 className="text-sm font-semibold text-foreground">{t("pipelineSettings.breakdown.title", { defaultValue: "Break into smaller pieces" })}</h3>
          <p className="max-w-md text-sm text-muted-foreground">
            {t("pipelineSettings.breakdown.subtitle", { defaultValue: "The agent decides what the pieces are. Paperclip creates and tracks them." })}
          </p>
        </div>
        <ToggleSwitch
          aria-label={t("pipelineSettings.breakdown.title", { defaultValue: "Break into smaller pieces" })}
      ...
      {breakdownEnabled ? (
        <div className="divide-y divide-border px-4">
          <FieldRow label={t("pipelineSettings.breakdown.createEachPieceIn", { defaultValue: "Create each piece in" })}>
            <div className="space-y-1">
              <div className="flex w-full max-w-sm items-center">
                <select
                  aria-label={t("pipelineSettings.breakdown.createEachPieceIn", { defaultValue: "Create each piece in" })}
                ...
                >
                  <option value="">{t("pipelineSettings.breakdown.choosePipeline", { defaultValue: "Choose a pipeline" })}</option>
                ...
                {breakdownTargetPipelineId ? (
                  <Link
                    ...
                    aria-label={t("pipelineSettings.breakdown.openPipelineAria", { defaultValue: "Open {{name}} pipeline", name: breakdownTargetPipeline?.name ?? t("pipelineSettings.breakdown.selectedPipelineFallbackShort", { defaultValue: "selected" }) })}
                    title={t("pipelineSettings.breakdown.openPipelineAria", { defaultValue: "Open {{name}} pipeline", name: breakdownTargetPipeline?.name ?? t("pipelineSettings.breakdown.selectedPipelineFallbackShort", { defaultValue: "selected" }) })}
              ...
              {!breakdownTargetPipelineId ? (
                <p className="text-xs text-muted-foreground">{t("pipelineSettings.breakdown.pipelineHint", { defaultValue: "A pipeline in this workspace" })}</p>
              ) : null}
            </div>
          </FieldRow>
          <FieldRow label={t("pipelineSettings.breakdown.startingAt", { defaultValue: "starting at" })}>
            <div className="space-y-1">
              <select
                aria-label={t("pipelineSettings.breakdown.startingStageAria", { defaultValue: "Starting stage for each piece" })}
              ...
              >
                <option value="">{t("pipelineSettings.common.chooseStage", { defaultValue: "Choose a stage" })}</option>
                {breakdownTargetStages.map((stage) => (
                  <option key={stage.id} value={stage.key}>{stage.name}</option>
                ))}
              </select>
              <p className="text-xs text-muted-foreground">{t("pipelineSettings.breakdown.startingStageHint", { defaultValue: "The stage every new piece starts in" })}</p>
            </div>
          </FieldRow>
          <FieldRow label={t("pipelineSettings.breakdown.callEachPieceA", { defaultValue: "Call each piece a" })}>
            <div className="space-y-1">
              <Input
                aria-label={t("pipelineSettings.breakdown.callEachPieceA", { defaultValue: "Call each piece a" })}
              ...
              />
              <p className="text-xs text-muted-foreground">
                {t("pipelineSettings.breakdown.pieceNounHint", { defaultValue: "Drives copy on this case (e.g. “3 of 5 {{plural}} finished”)", plural: breakdownPieceNounPlural })}
              </p>
            </div>
          </FieldRow>
          <FieldRow label={t("pipelineSettings.fields.carryOver", { defaultValue: "Carry over" })}>
            <div className="space-y-2">
              <div className="space-y-1 rounded-md border border-dashed border-border bg-muted/30 px-3 py-2 text-xs">
                <p className="text-muted-foreground">
                  {t("pipelineSettings.carryOver.description", { defaultValue: "Values are copied from this item and its ancestors. New eligible fields stay on unless you uncheck them." })}
                </p>
                {breakdownTargetPipelineId ? (
                  <div className="flex flex-wrap items-center gap-1 text-muted-foreground">
                    <span>{t("pipelineSettings.carryOver.destinationValidation", { defaultValue: "Destination validation:" })}</span>
                    <span className="font-medium text-foreground">
                      {breakdownTargetPipeline?.name ?? t("pipelineSettings.carryOver.selectedPipelineFallback", { defaultValue: "selected pipeline" })}
                    </span>
                ...
                {breakdownIntakeSettingsHref ? (
                  ...
                  >
                    {t("pipelineSettings.carryOver.reviewDestinationFields", { defaultValue: "Review destination fields" })}
                ...
                {breakdownTargetArchived ? (
                  <p className="flex items-center gap-1 text-amber-700 dark:text-amber-300">
                    ...
                    {t("pipelineSettings.carryOver.archivedNotice", { defaultValue: "This destination pipeline is archived, so its validation fields can't be edited until it's restored." })}
                  </p>
                ) : null}
              </div>
                            ...
                            >
                              ...
                              {targetField?.required ? (
                                <span className="text-xs text-muted-foreground">
                                  {t("pipelineSettings.carryOver.requiredBy", { defaultValue: "Required by {{name}}", name: breakdownTargetPipeline?.name ?? t("pipelineSettings.carryOver.destinationFallback", { defaultValue: "destination" }) })}
                                </span>
                              ) : targetField ? (
                                <span className="text-xs text-muted-foreground">
                                  {t("pipelineSettings.carryOver.validatedBy", { defaultValue: "Validated by {{name}}", name: breakdownTargetPipeline?.name ?? t("pipelineSettings.carryOver.destinationFallback", { defaultValue: "destination" }) })}
                                </span>
                              ) : null}
                            </label>
                          );
              ...
              {breakdownCarryOverFieldGroups.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  {t("pipelineSettings.carryOver.noFields", { defaultValue: "This pipeline and its ancestors do not define any fields that can be carried over yet." })}
                </p>
              ) : null}
              <p className="text-xs text-muted-foreground">
                {t("pipelineSettings.carryOver.uniqueFieldsNote", { defaultValue: "Name and title fields are kept unique for each new {{noun}}.", noun: breakdownPieceNoun.trim() || "piece" })}
              </p>
            </div>
          </FieldRow>
          <FieldRow label={t("pipelineSettings.breakdown.thenMoveCaseTo", { defaultValue: "Then move this case to" })}>
            <div className="space-y-1">
              <select
                aria-label={t("pipelineSettings.breakdown.thenMoveCaseTo", { defaultValue: "Then move this case to" })}
              ...
              >
                <option value="">{t("pipelineSettings.breakdown.stayOnThisStep", { defaultValue: "Stay on this step" })}</option>
                {otherStages.map((stage) => (
                  <option key={stage.id} value={stage.key}>{stage.name}</option>
                ))}
              </select>
              <p className="text-xs text-muted-foreground">{t("pipelineSettings.breakdown.advanceHint", { defaultValue: "As soon as the pieces are created" })}</p>
            </div>
          </FieldRow>
          <FieldRow label={t("pipelineSettings.fields.wait", { defaultValue: "Wait" })}>
            <div className="space-y-2">
              <label className="flex items-start gap-2 text-sm">
                ...
                />
                <span className="font-medium text-foreground">
                  {t("pipelineSettings.breakdown.waitUntilFinished", { defaultValue: "Wait until all {{plural}} are finished, then move it to", plural: breakdownPieceNounPlural })}
                </span>
              </label>
              <select
                aria-label={t("pipelineSettings.breakdown.moveWhenPiecesFinishAria", { defaultValue: "Move this case when all pieces finish" })}
              ...
              {breakdownAdvanceTo ? (
                <p className="text-xs text-muted-foreground">
                  {t("pipelineSettings.breakdown.advanceFallbackHint", { defaultValue: "If nothing is worth splitting, this case still moves to {{stageName}}.", stageName: breakdownCopyNames.advanceToName })}
                </p>
              ) : null}
            </div>
          </FieldRow>
    ...
    <div className="space-y-6">
      ...
      >
        <div className="mb-3 flex items-start justify-between gap-3">
          <Link to={`/pipelines/${pipeline.id}`} className="text-sm text-muted-foreground hover:text-foreground">
            {t("pipelineSettings.nav.backToBoard", { defaultValue: "Back to board" })}
          </Link>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button type="button" variant="outline" size="icon" className="h-8 w-8" title={t("pipelineSettings.actions.pipelineActions", { defaultValue: "Pipeline actions" })}>
            ...
            <DropdownMenuContent align="end">
              {isArchived ? (
                <DropdownMenuItem onSelect={() => archivePipeline.mutate(false)}>
                  ...
                  {t("pipelineSettings.actions.restorePipeline", { defaultValue: "Restore pipeline" })}
                </DropdownMenuItem>
              ) : (
                <DropdownMenuItem variant="destructive" onSelect={() => setArchiveDialogOpen(true)}>
                  <Archive className="h-4 w-4" />
                  {t("pipelineSettings.actions.archivePipeline", { defaultValue: "Archive pipeline" })}
                </DropdownMenuItem>
              )}
            </DropdownMenuContent>
          </DropdownMenu>
        ...
        <div className="grid gap-3 md:grid-cols-(--gtc-13) md:items-end">
          <div className="space-y-3">
            <label className="block space-y-1.5 text-sm font-medium">
              <span className="sr-only">{t("pipelineSettings.fields.pipelineName", { defaultValue: "Pipeline name" })}</span>
              <Input
                aria-label={t("pipelineSettings.fields.pipelineName", { defaultValue: "Pipeline name" })}
                value={pipelineName}
            ...
            <label className="block space-y-1.5 text-sm font-medium">
              <span className="sr-only">{t("pipelineSettings.fields.pipelineDescription", { defaultValue: "Pipeline description" })}</span>
              <Textarea
                aria-label={t("pipelineSettings.fields.pipelineDescription", { defaultValue: "Pipeline description" })}
                value={pipelineDescription}
                onChange={(event) => setPipelineDescription(event.target.value)}
                rows={2}
                placeholder={t("pipelineSettings.fields.addDescriptionPlaceholder", { defaultValue: "Add a description" })}
          ...
          {detailsDirty || savePipelineDetails.isPending ? (
            <Button type="submit" disabled={savePipelineDetails.isPending || !pipelineName.trim()}>
              ...
              {savePipelineDetails.isPending ? t("pipelineSettings.actions.saving", { defaultValue: "Saving..." }) : t("pipelineSettings.actions.saveDetails", { defaultValue: "Save details" })}
            </Button>
          ) : null}
        </div>
      ...
      <div className="space-y-6">
          {stages.length === 0 ? (
            <EmptyState
              icon={GitBranch}
              message={t("pipelineSettings.empty.noStages", { defaultValue: "No stages configured." })}
              action={t("pipelineSettings.actions.addFirstStage", { defaultValue: "Add first stage" })}
            ...
            <div className="overflow-x-auto border-y border-border py-4">
              <div className="flex min-w-max items-center gap-2">
                {stages.map((stage, index) => {
                  ...
                  const warningWord = warningCount === 1
                    ? t("pipelineSettings.stageCard.warningSingular", { defaultValue: "warning" })
                    : t("pipelineSettings.stageCard.warningPlural", { defaultValue: "warnings" });
                  const warningBadge = t("pipelineSettings.stageCard.warningBadge", { defaultValue: "{{count}} {{word}}", count: warningCount, word: warningWord });
                    ...
                    <div key={stage.id} className="flex items-center gap-2">
                      <div className="flex flex-col items-start gap-1">
                        <button
                          ...
                          aria-label={
                            warningCount > 0
                              ? t("pipelineSettings.stageCard.warningAria", { defaultValue: "{{name}}, {{badge}}", name: stage.name, badge: warningBadge })
                              : stage.name
                          }
                          className={cn(
                        ...
                        >
                          ...
                          <span className="mt-1 block text-xs text-muted-foreground">{t("pipelineSettings.stageCard.step", { defaultValue: "Step {{number}}", number: index + 1 })}</span>
                          {stageNewEntriesDisabled(stage) ? (
                            <span className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-amber-700 dark:text-amber-300">
                              ...
                              {t("pipelineSettings.stageCard.newEntriesPaused", { defaultValue: "New entries paused" })}
                            </span>
                          ) : null}
                        </button>
                        <Link
                        ...
                        >
                          {t("pipelineSettings.stageCard.viewQueue", { defaultValue: "View queue" })}
                      ...
                      {canInsertAfter ? (
                        <button
                          type="button"
                          aria-label={t("pipelineSettings.stageCard.insertStageAfter", { defaultValue: "Insert stage after {{name}}", name: stage.name })}
                ...
                <div className="min-w-0 flex-1 md:px-8">
                    ...
                    {activeStageSection === "instructions" ? (
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          title={newEntriesDisabled ? t("pipelineSettings.actions.resumeNewEntries", { defaultValue: "Resume new entries" }) : t("pipelineSettings.actions.pauseNewEntries", { defaultValue: "Pause new entries" })}
                          aria-label={newEntriesDisabled ? t("pipelineSettings.actions.resumeNewEntries", { defaultValue: "Resume new entries" }) : t("pipelineSettings.actions.pauseNewEntries", { defaultValue: "Pause new entries" })}
                        ...
                        <Button
                          ...
                          title={t("pipelineSettings.actions.deleteNamed", { defaultValue: "Delete {{name}}", name: selectedStage.name })}
                          aria-label={t("pipelineSettings.actions.deleteNamed", { defaultValue: "Delete {{name}}", name: selectedStage.name })}
                  ...
                  {activeStageSection === "instructions" ? (
                    <div className="w-full max-w-3xl">
                      <div className="divide-y divide-border border-b border-border">
                        <FieldRow label={t("pipelineSettings.fields.name", { defaultValue: "Name" })}>
                          <Input value={stageName} onChange={(event) => setStageName(event.target.value)} required />
                        </FieldRow>
                        <FieldRow label={t("pipelineSettings.fields.stepType", { defaultValue: "Step type" })}>
                            ...
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <Button
                                  type="button"
                                  variant="outline"
                                  aria-label={t("pipelineSettings.fields.stepType", { defaultValue: "Step type" })}
                        ...
                        {stageKind === "review" ? (
                          <FieldRow label={t("pipelineSettings.fields.approver", { defaultValue: "Approver" })}>
                            <InlineEntitySelector
                              value={selectedApproval === "any_human" ? "" : selectedApproval}
                              options={approvalOptions}
                              recentOptionIds={recentAssigneeOptionIds}
                              placeholder={t("pipelineSettings.fields.approver", { defaultValue: "Approver" })}
                              noneLabel={t("pipelineSettings.approver.anyHuman", { defaultValue: "Any human" })}
                              searchPlaceholder={t("pipelineSettings.approver.searchPlaceholder", { defaultValue: "Search approvers..." })}
                              emptyMessage={t("pipelineSettings.approver.noneFound", { defaultValue: "No approvers found." })}
                              onChange={(value) => setSelectedApproval(approverValueFromOption(value))}
                              renderTriggerValue={(option) => {
                                if (!option) return <span className="text-muted-foreground">{t("pipelineSettings.approver.anyHuman", { defaultValue: "Any human" })}</span>;
                        ...
                        {stageKind === "review" ? (
                          <FieldRow label={t("pipelineSettings.review.outcomes", { defaultValue: "Review outcomes" })}>
                            <div className="space-y-2">
                              {([
                                [t("pipelineSettings.review.approvedMoveTo", { defaultValue: "Approved items move to" }), approveTarget, setApproveTarget, t("pipelineSettings.common.chooseStage", { defaultValue: "Choose a stage" })],
                                [t("pipelineSettings.review.declinedMoveTo", { defaultValue: "Declined items move to" }), rejectTarget, setRejectTarget, t("pipelineSettings.common.chooseStage", { defaultValue: "Choose a stage" })],
                                [t("pipelineSettings.review.changesMoveTo", { defaultValue: "Items needing changes move to" }), requestChangesTarget, setRequestChangesTarget, t("pipelineSettings.review.stayInReview", { defaultValue: "Stay in review" })],
                              ...
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-42)">
                                <span className="text-sm font-medium">{t("pipelineSettings.review.noteWhenRequestingChanges", { defaultValue: "Ask for a note when requesting changes" })}</span>
                                <div className="sm:justify-self-start">
                                  <ToggleSwitch checked={requireRequestChangesReason} onCheckedChange={setRequireRequestChangesReason} />
                                </div>
                              </div>
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-42)">
                                <span className="text-sm font-medium">{t("pipelineSettings.review.noteWhenDeclining", { defaultValue: "Ask for a note when declining" })}</span>
                                <div className="sm:justify-self-start">
                            ...
                            {reviewTargetsMissing ? (
                              <p className="mt-2 text-sm text-muted-foreground">
                                {t("pipelineSettings.review.pickTargetsHint", { defaultValue: "Pick where approved and declined items should go before saving." })}
                              </p>
                            ) : null}
                          </FieldRow>
                        ) : null}
                    ...
                    <div className="mt-8 w-full max-w-3xl space-y-6">
                      <div className="overflow-x-auto overscroll-x-contain">
                        <div className="inline-flex min-w-full flex-wrap items-center gap-2 text-sm text-muted-foreground sm:min-w-max sm:flex-nowrap">
                          <span>{t("pipelineSettings.automation.whenItemEnters", { defaultValue: "When an item enters this step" })}</span>
                          <InlineEntitySelector
                            value={stageAssigneeOptionId(stageAssigneeAgentId)}
                            options={stageAssigneeOptions}
                            recentOptionIds={recentAssigneeOptionIds}
                            placeholder={t("pipelineSettings.automation.pickAgent", { defaultValue: "Pick agent" })}
                            noneLabel={t("pipelineSettings.automation.noAutomation", { defaultValue: "No automation" })}
                            searchPlaceholder={t("pipelineSettings.automation.searchAgents", { defaultValue: "Search agents..." })}
                            emptyMessage={t("pipelineSettings.automation.noAgentsFound", { defaultValue: "No agents found." })}
                            onChange={(value) => setStageAssigneeAgentId(stageAssigneeIdFromOption(value))}
                            renderTriggerValue={(option) => {
                              if (!option) return <span className="text-muted-foreground">{t("pipelineSettings.automation.pickAgent", { defaultValue: "Pick agent" })}</span>;
                          ...
                          />
                          <span>{t("pipelineSettings.automation.runsInstructions", { defaultValue: "runs these instructions, then moves the item to the next step." })}</span>
                        </div>
                      </div>
                      ...
                      {selectedAutomationAgent ? (
                        <>
                          <div className="divide-y divide-border border-y border-border">
                            <FieldRow label={t("pipelineSettings.fields.projectContext", { defaultValue: "Project context" })}>
                              <div className="grid gap-2 sm:grid-cols-(--gtc-43)">
                                <InlineEntitySelector
                                  value={stageProjectId}
                                  options={projectOptions}
                                  recentOptionIds={recentProjectIds}
                                  placeholder={t("pipelineSettings.fields.project", { defaultValue: "Project" })}
                                  noneLabel={t("pipelineSettings.automation.noProject", { defaultValue: "No project" })}
                                  searchPlaceholder={t("pipelineSettings.automation.searchProjects", { defaultValue: "Search projects..." })}
                                  emptyMessage={t("pipelineSettings.automation.noProjectsFound", { defaultValue: "No projects found." })}
                                  ...
                                  renderTriggerValue={(option) =>
                                    option && selectedAutomationProject ? (
                                      ...
                                      <span className="text-muted-foreground">{t("pipelineSettings.fields.project", { defaultValue: "Project" })}</span>
                                    )
                                  }
                                  renderOption={(option) => {
                                    if (!option.id) return <span className="truncate">{option.label}</span>;
                                ...
                                {selectedAutomationProject ? (
                                  <select
                                    aria-label={t("pipelineSettings.fields.projectWorkspace", { defaultValue: "Project workspace" })}
                                    value={stageProjectWorkspaceId}
                                    onChange={(event) => handleAutomationProjectWorkspaceChange(event.target.value)}
                                    className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm"
                                  >
                                    <option value="">{t("pipelineSettings.automation.projectFallback", { defaultValue: "Project fallback" })}</option>
                                    {(selectedAutomationProject.workspaces ?? []).map((workspace) => (
                                      <option key={workspace.id} value={workspace.id}>
                                        {workspace.name}{workspace.isPrimary ? t("pipelineSettings.automation.primarySuffix", { defaultValue: " · primary" }) : ""}
                                      </option>
                                    ))}
                                  </select>
                                ) : (
                                  <div className="flex h-10 items-center rounded-md border border-dashed border-border px-3 text-sm text-muted-foreground">
                                    {t("pipelineSettings.fields.projectWorkspace", { defaultValue: "Project workspace" })}
                                  </div>
                                )}
                              </div>
                              {selectedAutomationProject && !selectedAutomationProjectWorkspace ? (
                                <p className="mt-2 text-xs text-muted-foreground">
                                  {t("pipelineSettings.automation.noWorkspaceDefaultHint", { defaultValue: "This project has no saved workspace default. Paperclip will use the project fallback when automation runs." })}
                                </p>
                              ) : null}
                            </FieldRow>

                            {selectedAutomationProject && selectedProjectSupportsExecutionWorkspace ? (
                              <FieldRow label={t("pipelineSettings.fields.executionWorkspace", { defaultValue: "Execution workspace" })}>
                                <div className="grid gap-2 sm:grid-cols-(--gtc-43)">
                                  <select
                                    aria-label={t("pipelineSettings.automation.executionWorkspaceModeAria", { defaultValue: "Execution workspace mode" })}
                                  ...
                                  {stageExecutionWorkspacePreference === "reuse_existing" ? (
                                    <select
                                      aria-label={t("pipelineSettings.automation.existingWorkspaceAria", { defaultValue: "Existing execution workspace" })}
                                      value={stageExecutionWorkspaceId}
                                      onChange={(event) => handleAutomationExecutionWorkspaceIdChange(event.target.value)}
                                      className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm"
                                    >
                                      <option value="">{t("pipelineSettings.automation.chooseExistingWorkspace", { defaultValue: "Choose an existing workspace" })}</option>
                                    ...
                                    <div className="flex h-10 items-center rounded-md border border-dashed border-border px-3 text-sm text-muted-foreground">
                                      {stageExecutionWorkspacePreference === "isolated_workspace"
                                        ? t("pipelineSettings.automation.newWorkspaceCreated", { defaultValue: "A new workspace will be created" })
                                        : t("pipelineSettings.automation.projectDefaultWorkspace", { defaultValue: "Project default workspace" })}
                                    </div>
                                  )}
                                </div>
                                {stageExecutionWorkspacePreference === "reuse_existing" && selectedReusableExecutionWorkspace ? (
                                  <p className="mt-2 text-xs text-muted-foreground">
                                    {t("pipelineSettings.automation.reusingWorkspace", { defaultValue: "Reusing {{name}} from {{source}}.", name: selectedReusableExecutionWorkspace.name, source: selectedReusableExecutionWorkspace.branchName ?? selectedReusableExecutionWorkspace.cwd ?? t("pipelineSettings.automation.existingWorkspaceFallback", { defaultValue: "existing workspace" }) })}
                                  </p>
                                ) : null}
                                {!canSaveAutomationWorkspace ? (
                                  <p className="mt-2 text-xs text-amber-700 dark:text-amber-300">
                                    {t("pipelineSettings.automation.chooseBeforeReuse", { defaultValue: "Choose an existing workspace before saving reuse mode." })}
                                  </p>
                                ) : null}
                              </FieldRow>
                            ) : null}
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <span>{t("pipelineSettings.automation.agentRunsStep", { defaultValue: "{{name}} runs this step automatically.", name: selectedAutomationAgent.name })}</span>
                          </div>
                          <FieldRow label={t("pipelineSettings.fields.issueTitle", { defaultValue: "Issue title" })}>
                            <Input
                              ref={issueTitleTemplateInputRef}
                              aria-label={t("pipelineSettings.fields.issueTitleTemplate", { defaultValue: "Issue title template" })}
                          ...
                          <AutomationVariableTokenHelper
                            ...
                            label={t("pipelineSettings.automationVariables.issueTitleHeading", { defaultValue: "Issue title variables" })}
                          />
                          {breakdownEnabled ? (
                            <div className="space-y-1">
                              <h3 className="text-sm font-semibold text-foreground">{t("pipelineSettings.breakdown.agentDecideTitle", { defaultValue: "What should the agent decide?" })}</h3>
                              <p className="text-sm text-muted-foreground">
                                {t("pipelineSettings.breakdown.agentDecideHint", { defaultValue: "The mechanics are handled below. Write only the judgment." })}
                              </p>
                            </div>
                          ) : null}
                          <div data-testid="stage-instructions-editor">
                            <MarkdownEditor
                              ...
                              placeholder={
                                breakdownEnabled
                                  ? t("pipelineSettings.automation.instructionsPlaceholderBreakdown", { defaultValue: "Describe the judgment the agent should make — what counts as a piece worth splitting out?" })
                                  : t("pipelineSettings.automation.instructionsPlaceholder", { defaultValue: "Tell the agent exactly what to do when an item enters this step..." })
                              }
                              bordered={false}
                        ...
                        <EmptyState
                          icon={Pause}
                          message={t("pipelineSettings.automation.noAutomationEmpty", { defaultValue: "Nothing runs here automatically. Items wait until a person moves them, or you can pick an agent to run this step." })}
                        />
                      )}
                      <div className="space-y-3">
                  ...
                  {activeStageSection === "advanced" ? (
                    <div className="w-full max-w-3xl space-y-8">
                      <div className="divide-y divide-border border-b border-border">
                        <div className="py-3">
                          <h3 className="text-sm font-semibold text-foreground">{t("pipelineSettings.advanced.transitions", { defaultValue: "Transitions" })}</h3>
                        </div>
                        <FieldRow label={t("pipelineSettings.advanced.strictMode", { defaultValue: "Strict mode" })}>
                          <div className="space-y-1.5">
                            <div className="flex items-center gap-3">
                              <ToggleSwitch
                                aria-label={t("pipelineSettings.advanced.strictlyEnforce", { defaultValue: "Strictly enforce transitions" })}
                              ...
                              <span className="text-sm font-medium text-foreground">
                                {t("pipelineSettings.advanced.strictlyEnforce", { defaultValue: "Strictly enforce transitions" })}
                              </span>
                            </div>
                            <p className="max-w-2xl text-sm text-muted-foreground">
                              {strictTransitionsEnabled
                                ? t("pipelineSettings.advanced.strictOnHint", { defaultValue: "Items can only move to configured next steps. Operators can force an off-path move by giving a reason." })
                                : t("pipelineSettings.advanced.strictOffHint", { defaultValue: "Items can move to any step. Saved allowed-next-step choices are kept, but they are not enforced." })}
                            </p>
                          </div>
                        </FieldRow>
                      ...
                      {isPipelineTerminalStageKind(stageKind) ? null : breakdownEnabled ? (
                        <EmptyState
                          ...
                          message={t("pipelineSettings.advanced.childSettingsHidden", { defaultValue: "Advanced child settings are hidden while Break into smaller pieces is enabled. Configure that workflow in Automation." })}
                        />
                      ) : (
                        <div className="divide-y divide-border border-b border-border">
                          <div className="py-3">
                            <h3 className="text-sm font-semibold text-foreground">{t("pipelineSettings.advanced.children", { defaultValue: "Children" })}</h3>
                          </div>
                          <FieldRow label={t("pipelineSettings.advanced.blockChildren", { defaultValue: "Block children" })}>
                            <div className="space-y-1.5">
                              <div className="flex items-center gap-3">
                                <ToggleSwitch
                                ...
                                />
                                <span className="text-sm font-medium text-foreground">
                                  {t("pipelineSettings.advanced.blockUntilChildrenDone", { defaultValue: "Block until all child items are done or cancelled" })}
                                </span>
                              </div>
                              <p className="max-w-2xl text-sm text-muted-foreground">
                                {t("pipelineSettings.advanced.blockChildrenHint", { defaultValue: "When on, this step can't move forward while any child item is still open. When off, items can move through even with open children." })}
                              </p>
                            </div>
                          </FieldRow>
                          <FieldRow label={t("pipelineSettings.advanced.advanceChildren", { defaultValue: "Advance children" })}>
                            <div className="space-y-3">
                              <div className="flex items-center gap-3">
                                <ToggleSwitch
                                ...
                                />
                                <span className="text-sm font-medium text-foreground">
                                  {t("pipelineSettings.advanced.advanceWhenLastChildDone", { defaultValue: "Advance when the last child is done" })}
                                </span>
                              </div>
                              <div className="grid grid-cols-1 items-center gap-2 sm:grid-cols-(--gtc-44)">
                                <span className="text-sm font-medium text-muted-foreground">{t("pipelineSettings.advanced.moveTo", { defaultValue: "Move to" })}</span>
                                <select
                                  aria-label={t("pipelineSettings.advanced.moveToWhenChildrenFinishAria", { defaultValue: "Move to stage when children finish" })}
                              ...
                              <p className="max-w-2xl text-sm text-muted-foreground">
                                {t("pipelineSettings.advanced.advanceChildrenHint", { defaultValue: "When on and every child is done, this step moves the item forward automatically. When off, someone has to move it." })}
                              </p>
                            </div>
                          </FieldRow>
                        </div>
                    ...
                    <div className="w-full space-y-3">
                      {stageEventsQuery.isLoading ? (
                        ...
                        <StageEventsList
                          events={stageEvents}
                          stages={stages}
                          emptyMessage={t("pipelineSettings.activity.empty", { defaultValue: "No stage activity yet." })}
                        />
                      )}
                    </div>
                  ) : null}
              ...
              {stageDirty || saveStage.isPending ? (
                <div className="sticky bottom-0 z-10 -mx-6 mt-6 flex items-center justify-between gap-3 border-t border-border bg-background/95 px-6 py-3 backdrop-blur motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2">
                  <span className="text-sm text-muted-foreground">
                    {saveStage.isPending ? t("pipelineSettings.actions.savingChanges", { defaultValue: "Saving changes…" }) : t("pipelineSettings.actions.unsavedChanges", { defaultValue: "You have unsaved changes." })}
                  </span>
                  <Button
                    type="submit"
                  ...
                  >
                    ...
                    {saveStage.isPending ? t("pipelineSettings.actions.saving", { defaultValue: "Saving..." }) : t("pipelineSettings.actions.saveStage", { defaultValue: "Save stage" })}
                  </Button>
                </div>
              ) : null}
            </form>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("pipelineSettings.deleteDialog.title", { defaultValue: "Delete stage" })}</DialogTitle>
            <DialogDescription>
              {t("pipelineSettings.deleteDialog.description", { defaultValue: "Delete {{name}} from this pipeline. Connected stage transitions are removed.", name: selectedStage?.name ?? t("pipelineSettings.deleteDialog.thisStageFallback", { defaultValue: "this stage" }) })}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            {stages.length > 1 ? (
              <label className="block space-y-1.5 text-sm font-medium">
                <span>{t("pipelineSettings.deleteDialog.moveItemsTo", { defaultValue: "Move existing items to" })}</span>
                <select
                  aria-label={t("pipelineSettings.deleteDialog.moveItemsTo", { defaultValue: "Move existing items to" })}
              ...
              <p className="text-sm text-muted-foreground">
                {t("pipelineSettings.deleteDialog.onlyStageHint", { defaultValue: "This is the only stage. Deletion succeeds only if it has no items." })}
              </p>
            )}
            {deleteStage.error ? (
          ...
          <DialogFooter>
            ...
            >
              {t("pipelineSettings.common.cancel", { defaultValue: "Cancel" })}
            </Button>
            <Button
              type="button"
              variant="destructive"
            ...
            >
              <Trash2 className="h-4 w-4" />
              {deleteStage.isPending ? t("pipelineSettings.actions.deleting", { defaultValue: "Deleting..." }) : t("pipelineSettings.deleteDialog.title", { defaultValue: "Delete stage" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("pipelineSettings.actions.archivePipeline", { defaultValue: "Archive pipeline" })}</DialogTitle>
            <DialogDescription>
              {t("pipelineSettings.archiveDialog.description", { defaultValue: "Archiving hides this pipeline from everyday views. Its stages and items are kept and can be restored later." })}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <label className="block space-y-1.5 text-sm font-medium">
              <span>{t("pipelineSettings.archiveDialog.typeToConfirm", { defaultValue: "Type {{name}} to confirm", name: pipeline.name })}</span>
              <Input
                aria-label={t("pipelineSettings.archiveDialog.confirmationAria", { defaultValue: "Archive confirmation" })}
          ...
          <DialogFooter>
            ...
            >
              <Archive className="h-4 w-4" />
              {archivePipeline.isPending ? t("pipelineSettings.actions.archiving", { defaultValue: "Archiving..." }) : t("pipelineSettings.actions.archivePipeline", { defaultValue: "Archive pipeline" })}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
