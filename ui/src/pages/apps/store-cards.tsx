    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="text-sm font-semibold text-foreground">
          {t("storeCards.byoConnect.title", { defaultValue: "Connect your own tool" })}
        </div>
        <div className="text-xs text-muted-foreground">
          {t("storeCards.byoConnect.description", {
            defaultValue:
      ...
      <span className="shrink-0 text-xs font-semibold text-primary">
        {t("storeCards.byoConnect.action", { defaultValue: "Connect →" })}
      </span>
    </button>
  );
}
...
export function AdvancedToolsLink() {
  ...
  return (
    ...
    >
      ...
      {t("storeCards.advancedTools.link", { defaultValue: "Developer tools (advanced)" })}
    </Link>
  );
}
