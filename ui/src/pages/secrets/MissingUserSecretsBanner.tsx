...
export function MissingUserSecretsBanner({
  ...
  const resolvedTitle =
    title ?? t("missingUserSecretsBanner.title", { defaultValue: "Set your user secrets" });
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-amber-700/90 dark:text-amber-300/90">
            {t("missingUserSecretsBanner.summary", {
            ...
            {missing.map((entry) => (
              ...
              >
                ...
                <Button size="sm" onClick={() => setDialogFor(entry)}>
                  {t("missingUserSecretsBanner.actions.setValue", { defaultValue: "Set value" })}
                </Button>
              </li>
            ))}
          </ul>
          {secretsPath ? (
            ...
            >
              {t("missingUserSecretsBanner.actions.manageAll", {
